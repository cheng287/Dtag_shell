...
DataParentPath1=/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/root                                                      
mypath=$PWD
jobDir=../output
        ...
        then
            ...
            then 
                ...
                # find  ${PWD}/mode_${decay_mode_points[$dm_i]}/ -name "${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}*.root" |sort > $mypath/temp.txt
                 find  ${PWD}/mode_${decay_mode_points[$dm_i]}/ -name "*_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}*.root" |sort > $mypath/temp.txt
            else
                #find  ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/ -name "${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}*.root" |sort >>$dst_list
                # find  ${PWD}/mode_${decay_mode_points[$dm_i]}/ -name "${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}*.root" |sort >> $mypath/temp.txt
                 find  ${PWD}/mode_${decay_mode_points[$dm_i]}/ -name "*_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}*.root" |sort >> $mypath/temp.txt
            ...
            do
                ...
                then 
                    ...
                    then
                        ...
                        sed -e s/XXX/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}/ ${mypath}/more_gaussian_fitjob.head > ${jobDir}/more_gaussian_fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp
                    else
                        ...
                        sed -e s/XXX/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}/ ${mypath}/more_gaussian_fit_Ds_fitjob.head > ${jobDir}/more_gaussian_fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp
                    fi
                ...
                then 
                    ...
                    sed -i "s#HHH#${CMS_energy[$ep_i]}#g" `grep HHH  -rl ${jobDir}/more_gaussian_fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp`

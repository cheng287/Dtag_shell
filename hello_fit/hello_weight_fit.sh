            ...
            do
                ...
                then 
                    ...
                    then
                        ...
                        sed -e s/XXX/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}/ ${mypath}/two_gaussian_fitjob.head > ${jobDir}/fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp
                    else
                        ...
                        sed -e s/XXX/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}/ ${mypath}/two_gaussian_Ds_fitjob.head > ${jobDir}/fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp
                    fi
                ...
                then 
                    ...
                    then       
                        ...
                        sed -e s/XXX/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}/ ${mypath}/two_gaussian_fitjob.tail >> ${jobDir}/fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp
                    else
                        ...
                        sed -e s/XXX/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}/ ${mypath}/two_gaussian_Ds_fitjob.tail >> ${jobDir}/fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp
                    fi
                    ...
                    sed -i "s#CUT_CUT#Data.mmode== ${decay_mode_points[$dm_i]} \&\& Data.mcharm == $CHARM_CHARM #g" `grep CUT_CUT  -rl ${jobDir}/fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp`
                    ...
                    then
                        sed -i "s#DDD#D^{+}#g" `grep DDD  -rl ${jobDir}/fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp`
                    fi

                    if [ ${decay_mode_points[$dm_i]} -lt 200 ]
                    then
                        sed -i "s#DDD#D^{0}#g" `grep DDD  -rl ${jobDir}/fit/mode_${decay_mode_points[$dm_i]}/${energy_points[$ep_i]}/mass_fit_${jobName}_${energy_points[$ep_i]}_mode${decay_mode_points[$dm_i]}_file_${ncount}.cpp`
                    fi

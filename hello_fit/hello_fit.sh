...
DataParentPath1=/scratchfs/bes/liucheng/cross_section/work_Rc/MC/D0_mode_0/test/output/root
        ...
        then
            ...
            do
                ...
                then 
                    ...
                    sed -i "s#CUT_CUT#Data.mmode== ${decay_mode_points[$dm_i]} \&\& Data.mcharm == $CHARM_CHARM #g" `grep CUT_CUT  -rl ${jobDir}/fit/mode_${decay_mode_points[$dm_i]}/mass_fit_${jobName}_mode${decay_mode_points[$dm_i]}_momentum_costheta_${ncount}.cpp`

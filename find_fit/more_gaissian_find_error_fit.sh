...
do
    ...
    echo "       CMS_energy   energy_point   luminosity          path                                               c0               c0_error          c1             c1_error                   nbkg            nbkg_error        nsig            nsig_error         " > ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_mode_${decay_mode_points[$dm_i]}.txt

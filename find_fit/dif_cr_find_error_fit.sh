...
do
    ...
    # echo "       CMS_energy   energy_point   luminosity          path                                               c0               c0_error          c1             c1_error           mean           mean_error        nbkg            nbkg_error        nsig            nsig_error       sigma            sigma_error    " > ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
    ...
    do 
        ...
        then
            ...
            #echo " CMS_energy   energy_point   luminosity          c0              c1                 mean              nbkg              nsig            sigma    " > ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
            #- - - -  - - 
            #echo " CMS_energy   energy_point   luminosity          path                                                                                  c0              c1                 mean              nbkg              nsig            sigma    " > ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
            ...
            do
                ...
                then
                    ...
                    then
                        ...
                        echo "* * *  STATUS error ! ! ! * * *"
                        #echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}        ${file_number[$xy-1]}             *                *                  *                  *                 *                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                        echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}        ${file_number[$xy-1]}             *              STATUS              ERROR               *                 *                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                    ...
                    then
                        ...
                        #echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}              *                *                  *                  *                 *                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                        #echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}        ${file_number[$xy-1]}             *                *                  *                  *                 *                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                        echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}        ${file_number[$xy-1]}             *              MATRIX               NOT             ACCURATE           ERROR              *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                    ...
                    then
                        ...
                        #echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}              *                *                  *                  *                 *                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                        #echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}        ${file_number[$xy-1]}             *                *                  *                  *                 *                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                        echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}        ${file_number[$xy-1]}             *             PARAMETER            ERROR               *                 *                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                    ...
                    do
                        ...
                        echo -n "        ${finial_2_points[$ixy-1]}" >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                    done

                    echo "" >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                    ...
                    echo " not found ! ! ! "
                    #echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}        ${file_number[$xy-1]}             *                not                  found                  !                 !                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt
                    echo "        ${CMS_energy[$ep_i]}        ${energy_points[$ep_i]}        ${luminostiy_points[$ep_i]}        ${file_number[$xy-1]}             *               NOT                FOUND              ERROR              *                *    " >> ${DataParentPath1}/mode_${decay_mode_points[$dm_i]}/result_${energy_points[$ep_i]}_mode_${decay_mode_points[$dm_i]}.txt

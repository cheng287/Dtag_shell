...
void fit_BW_1order()
{
	...
	gMinuit->mnparm(3,    "a0",      	 rdm_param[3],  step[3],   -1.e4  ,   1.e4  ,   ierflg  );
    gMinuit->mnparm(4,    "a1",          rdm_param[4],  step[4],   -1.5e4  ,   1.5e4,   ierflg  );	
	gMinuit->mnparm(5,    "Phi",         rdm_param[5],  step[5],   -180.   ,   180.   ,   ierflg );  

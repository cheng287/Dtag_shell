...
void fcn(Int_t &npar, Double_t *gin, Double_t &f, Double_t *par, Int_t iflag)
{
	...
	{
		nn[0] = x0[i];
		f0 = pow((yy0[i]-FF_fit_1_s_nointer(nn, par))/eyy0[i],2);
		f += f0;
	}
...
void fit_BW_1s_nointer_dressed()
{
	...
	gMinuit->mnparm(2,    "GammaEE",     rdm_param[2],  step[2],   0.     ,   260.   ,   ierflg );
  ...
  // =IF(MIN(N148:P148)<>0, ROUND(N148/MIN(N148:P148),0)&":"&ROUND(O148/MIN(N148:P148),0)&":"&ROUND(P148/MIN(N148:P148),0), "N/A")
	...
	c1->SaveAs("fit_bw_isr_nointer_dressed.png");
	// c1->SaveAs("fit_bw_isr_nointer_dressed.eps");

...
void draw_dressed()
{
    ...
    ifstream input_file1("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/select/obs_cross_section_allD.txt");
    ...
    ifstream input_file2("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/select/dressed2_cross_section_allD.txt");
    ...
    ifstream input_file3("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/select/dressed_cross_section_allD.txt");
	...
	legend->AddEntry(section_xx,"obs","ep");
	legend->AddEntry(section_xx_old,"dressed4","ep");
    legend->AddEntry(section_xx_old3,"dressed5","ep");
    legend->Draw();
    ...
    // c1->SaveAs("draw_dressed.png");
    c1->SaveAs("draw_all_dressed.png");

    c1->SaveAs("draw_all_dressed.eps");


    // c1->SaveAs("draw_dressed.root");

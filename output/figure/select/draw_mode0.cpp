...
void draw_mode0()
{
    ...
    char filename[200] = "/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/select/obs_cross_section_D0.txt";
    ...
    ifstream input_file1("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/select/obs_cross_section_D0.txt");
    ...
    ifstream input_file2("/scratchfs/bes/liucheng/cross_section/work_Rc/new_data/4612to4700/cross_section/obs_cross_section_mode0.txt");
    ...
    // TH2F *h_mode = new TH2F("h_mode"," ",100,4.6,5.0,100,2000,4000);
     TH2F *h_mode = new TH2F("h_mode"," ",200,3.7,5.0,100,0,10000);

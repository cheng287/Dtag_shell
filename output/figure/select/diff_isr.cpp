...
void diff_isr()
{
    char filename[200] = "/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/select/obs_cross_section_allD.txt";
    ...
    ifstream input_file1("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/select/diff_isr_4_5.txt");
    ...
    ifstream input_file2("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/select/diff_4.txt");
    ...
    ifstream input_file3("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/select/diff_1.txt");
    ...
    TH2F *h_mode = new TH2F("h_mode"," ",200,3.7,5.0,1000,-5,5);
    ...
    // NameAxes(h_mode, (char*)"#sqrt{#font[12]{s}} (GeV) ",(char*)" #sigma(e^{+}e^{-}#rightarrow D^{0}X + D^{+}X + D^{+}_{s}X) (pb)");
     NameAxes(h_mode, (char*)"#sqrt{#font[12]{s}} (GeV) ",(char*)" #Delta#sigma/#sigma %");
...
// 
    ...
    section_xx_old->SetMarkerSize(0.3);
    ...
    section_xx_old3->SetMarkerSize(0.3);
	...
	legend->AddEntry(section_xx,"diff - 4th vs 5th iterate","ep");
	// legend->AddEntry(section_xx_old,"diff - after 4 iterate","ep");
    // legend->AddEntry(section_xx_old3,"diff - after 1 iterate","ep");
    legend->Draw();
    ...
    c1->SaveAs("diff_isr_x.png");
    // c1->SaveAs("draw_all_o.png");

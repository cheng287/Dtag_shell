...
void draw_mode401()
{
    ...
    char filename[200] = "/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/obs_cross_section_Dsp.txt";
    ...
    ifstream input_file1("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/obs_cross_section_Dsp.txt");
    ...
    // TH2F *h_mode = new TH2F("h_mode"," ",100,4.6,5.0,100,2000,4000);
     TH2F *h_mode = new TH2F("h_mode"," ",200,3.7,5.0,100,0,2000);

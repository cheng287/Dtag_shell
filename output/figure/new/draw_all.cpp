...
void draw_all()
{
    ...
    char filename[200] = "/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/new/obs_all_xyz_select_rscan.txt";
    ...
    ifstream input_file3("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/new/obs_all_xyz_select_rscan.txt");
    ...
    section_xx_old3->SetMarkerColor(30);  // 3   29
    section_xx_old3->SetLineColor(30);    // 3
    // section_xx_old3->SetMarkerSize(1.);
    section_xx_old3->SetMarkerSize(0.5);
    section_xx_old3->SetMarkerStyle(21);  //27   8
	...
	legend->AddEntry(section_xx,"v1","ep");
	legend->AddEntry(section_xx_old,"old","ep");
    legend->AddEntry(section_xx_old3,"new","ep");
    legend->Draw();
    ...
    c1->SaveAs("draw_all_obs.png");
    c1->SaveAs("draw_all_obs.eps");
    // c1->SaveAs("draw_all_o.png");


    // c1->SaveAs("draw_all_obs.root");

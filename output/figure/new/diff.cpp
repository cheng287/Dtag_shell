...
void diff()
{
    ...
    ifstream input_file1("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/select/diff.txt");
...
// 
	...
	legend->AddEntry(section_xx,"diff - after 5 iterate","ep");

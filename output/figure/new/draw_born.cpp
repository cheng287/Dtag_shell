...
void draw_born()
{
    ...
    ifstream input_file2("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/select/dressed_cross_section_allD.txt");
    ...
    ifstream input_file3("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/figure/select/born_allD.txt");
	...
	legend->AddEntry(section_xx_old,"dressed","ep");
    legend->AddEntry(section_xx_old3,"Born","ep");
    legend->Draw();
    ...
    // c1->SaveAs("draw_born.png");
    c1->SaveAs("draw_all_born.png");
     c1->SaveAs("draw_all_born.eps");


    // c1->SaveAs("draw_born.root");

...
double class_new_isr::Cross(double S)
{
    ...
    {		      
		...
		TString FileName("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/test_cross_section_allD.txt");		
...
void isr_allD()
{
	...
	char filename[200] = "/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/obs_cross_section_allD.txt";
	...
	ifstream input_file1("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/obs_cross_section_allD.txt");
    for(int j = 0; j <row ; j++)
    {
        if(!input_file1.good())
            continue;

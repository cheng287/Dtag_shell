...
double class_new_isr::Cross(double S)
{
    ...
    {		      
		...
		TString FileName("/besfs5/groups/psip/psipgroup/user/liucheng/cross_section/Rc_new_run/new_low_xyz/output/isr_rc/select/test_cross_section_D0.txt");		
...
void isr_D0()
{
	...
	for(int j = 0; j <row ; j++)
	{
		...
		std::ofstream outputFile("all_D0.txt", std::ios::app);

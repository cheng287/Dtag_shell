...
with open('Nsig_mode0.txt', 'r') as file:
...
branch_ratio = 0.03947     #- - - D0 -> k- pi+         (3.947±0.030)% 
# branch_ratio = 0.0938     #- - - D+ -> k- pi+ pi+    ( 9.38 ± 0.16 )%
# branch_ratio = 0.0538     #- - - Ds+ -> k- k+ pi+     (  5.37±0.10 )%

write_file = open('obs_cross_section_mode0.txt',"w")

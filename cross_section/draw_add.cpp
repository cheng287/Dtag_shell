...
void draw_add()
{
    ...
    char filename[200] = "./add_obs_cross_section.txt";
    ...
    ifstream input_file1("./add_obs_cross_section.txt");
    ...
    ifstream input_file2("/scratchfs/bes/liucheng/cross_section/work_Rc/new_data/4612to4700/cross_section/add/obs_all.txt");
    ...
    c1->SaveAs("draw_add.png");
    c1->SaveAs("draw_add.root");
